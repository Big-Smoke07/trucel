...
import { ActivityType, Client, EmbedBuilder, GatewayIntentBits, Partials } from 'discord.js';
  ...
  if (command === '?leaderboard') {
    ...
    await message.reply({
      embeds: [new EmbedBuilder()
        ...
        .addFields(
          { name: 'Most upvotes received', value: rank('up', '⬆️') },
          { name: 'Most downvotes received', value: rank('down', '⬇️') },
        )],
    });
    return;
  }

  // Retire the old command without treating it as a request to open voting.
